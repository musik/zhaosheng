...
#set :repository,  "git@gitcafe.com:muzik/zhaosheng.git"
set :repository,  "git@github.com:musik/zhaosheng.git"

set :scm, :git

set :deploy_to, "/home/muzik/zhaosheng"
...
#NGinx
set :nginx_remote_config,"/etc/nginx/sites-enabled/zhaosheng.conf"
set :nginx_local_config, "./lib/templates/nginx.conf.erb"
set :application_uses_ssl, false
set :nginx_host_name,"zhaosheng100.com *.zhaoshengi100.com"
